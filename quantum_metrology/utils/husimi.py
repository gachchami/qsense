...
def plot_husimi_bloch(
   ...
   Returns
   -------
   ax: The Matplotlib 3-D axes object.
   """
    # ---- sanity checks -------------------------------------------------
...
def plot_all(J: int, experiments: List[Experiment]):
    ...
    titles = [
        "Q plot of coherent state", "Q plot of evolved coherent state",
        "Q plot of squeezed coherent state",
        "Q plot of the evolved squeezed state"
    ]
    _, axis = plt.subplots(4, 1, figsize=(6, 30),
