...
from config import TAU_SENSE
import numpy as np
from qutip import Qobj
from utils.husimi import compute_husimi_q
from utils.husimi import plot_husimi_q
from utils.metrology import calculate_phase_noise
from utils.plotting import plot_results


def process_final_states(final_states: List[Qobj], j: float,
    ...
    state_descriptions = [
        "Initial Coherent State", "Evolved Coherent State (SQL)",
        "Squeezed State", "Rotated Squeezed State",
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description='Quantum Metrology Simulation')
    ...
    phase_var_sql, phase_var_hl, final_states = calculate_phase_noise(
